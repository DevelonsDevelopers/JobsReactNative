...
function AccountInfo({ route, navigation }) {
  ...
  useEffect(() => {
    if (ID) {
      ...
      cvService
        .fetchByUser({ user: ID })
        .then((res) => {
          console.log("user cv fetch ", res.data);
          setIsLoading(false);
          setCV(res?.data);
        })
        .catch((err) => {
  ...
  const addEducation = (qualification, timeperiod, institute) => {
    ...
    cvService
      ...
      .then((res) => {
        ...
        console.log("res of eduation", res);
      })
      .catch((err) => {
  ...
  const updateCourse = async (course, timeperiod, institute, id) => {
    await updateCVCourse(cv.id, course, timeperiod, institute, id).then(
      (res) => {
        setTrigger(!trigger);
        setCouData(null);
      }
  ...
  const addInterest = (interest) => {
    ...
    cvService.addCVInterest({ cv:cv.id,interest: interest}).then((res) => {
  ...
  const addLanguage = (language) => {
    ...
    cvService.addCVLanguage({cv:cv.id,language: language}).then((res) => {
      setLang(res.data);
    });
    setTrigger(!trigger);
  };
  ...
  const addSkill = (skill) => {
    ...
    cvService.addCVSkill({cv:cv.id,skill: skill}).then((res) => {
      setSkills(res.data);
    });
    setTrigger(!trigger);
  };
          ...
          {error ? (
            ...
            <>
              <DeleteModal
                ...
                toggleVisibility={toggleDeleteVisibile}
                del={setDelVal}
                val={delV}
                setLoad={setDelLoad}
                isLoad={delLoad}
              ...
              <CareerModal
                ...
                toggleCareerVisibility={toggleCareerVisibility}
                add={addCareer}
                edit={updateCareer}
                data={carData}
              />
                  ...
                  <>
                    ...
                    >
                      <View style={{ flexDirection: "row" }}>
                        ...
                        <Pressable
                          onPress={() => editEducation({ status: 1 })}
                          style={{
                            backgroundColor: "#e7e7e7",
                            borderRadius: 25,
                            alignItems: "center",
                          ...
                          <FlatList
                            ...
                            renderItem={({ item }) => (
                              ...
                              >
                                ...
                                <Pressable
                                  onPress={() =>
                                    toggleDeleteVisibile("EDUCATION", item.id)
                                  }
                                  style={{ padding: 10 }}
                                >
                                  <Image
                                    ...
                                    source={require("../assets/cvDelete.png")}
                                  />
                                </Pressable>
                              </View>
                            )}
                          ...
                          <FlatList
                            ...
                            renderItem={({ item }) => (
                              ...
                              >
                                ...
                                <Pressable
                                  onPress={() =>
                                    toggleDeleteVisibile("CAREER", item.id)
                                  }
                                  style={{ padding: 10 }}
                                >
                                  <Image
                          ...
                          <FlatList
                            ...
                            renderItem={({ item }) => (
                              ...
                              >
                                ...
                                <Pressable
                                  onPress={() =>
                                    toggleDeleteVisibile("COURSE", item.id)
                                  }
                                  style={{ padding: 10 }}
                                >
                                  <Image
                          ...
                          <FlatList
                            ...
                            renderItem={({ item }) => (
                              ...
                              >
                                ...
                                <Pressable
                                  onPress={() =>
                                    toggleDeleteVisibile("SKILL", item.id)
                                  }
                                  style={{ padding: 10 }}
                                >
                                  <Image
                          ...
                          <FlatList
                            ...
                            renderItem={({ item }) => (
                              ...
                              >
                                ...
                                <Pressable
                                  onPress={() =>
                                    toggleDeleteVisibile("INTEREST", item.id)
                                  }
                                  style={{ padding: 10 }}
                                >
                                  <Image
                          ...
                          <FlatList
                            ...
                            renderItem={({ item }) => (
                              ...
                              >
                                ...
                                <Pressable
                                  onPress={() =>
                                    toggleDeleteVisibile("LANGUAGE", item.id)
                                  }
                                  style={{ padding: 10 }}
                                >
                                  <Image
