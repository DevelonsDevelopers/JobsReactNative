    ...
    <View style={{ flex: 1 }}>
      {isLoading ? (
        ...
        <>
              ...
              <View style={{ marginTop: 10 }}>
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ width: "50%" }}>
                      <View
                        style={{ flexDirection: "column", paddingVertical: 25 }}
                      >
                        <Text
                          style={{
                            textAlign: "center",
                  ...
                  {myarray?.map((value, index) => {
                    return (
                      <View style={{ marginLeft: "10%" }} key={index}>
                        <Text
                          style={{ fontSize: 12, fontFamily: "poppins_light" }}
                        >
                          {`\u2022 ${value}`}
                        </Text>
                      </View>
          ...
          >
            <Text
              onPress={() => navigation.push("AppliedByJob", { job: job?.id })}
              style={{
                fontSize: 16,
                fontFamily: "poppins_medium",
                backgroundColor: "#13A3E1",
