      ...
      {loading ? (
        ...
        <>
          <ScrollView style={{ flex: 1, backgroundColor: "#F1F1F1" }}>
            ...
            >
              <Pressable
                onPress={() => navigation.push("AppliedUsers", { screen: 0 })}
              ...
              <Pressable
                onPress={() => navigation.push("SentOffers", { screen: 1 })}
                style={{ flex: 1, paddingVertical: 20 }}
              >
                <Text
                  style={{
            ...
            >
              <Pressable
                onPress={() => navigation.push("ProviderAccountManage")}
              >
                <View
                  style={{
                    flexDirection: "row",
              ...
              <Pressable onPress={() => toggleLoadingVisibility()}>
                <View
                  style={{
                    flexDirection: "row",
                    flex: 1,
