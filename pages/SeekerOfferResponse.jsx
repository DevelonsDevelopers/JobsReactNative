            ...
            <View style={{ backgroundColor: "#EAEAEA" }}>
              <View style={{ flexDirection: "row", height: 90 }}>
                ...
                <View style={{ width: "100%", marginTop: 0, paddingEnd: 90 }}>
                  <Pressable onPress={() => navigation.push("OfferRejected")}>
                    <Image
                      style={{
                        width: 150,
                        height: 40,
              ...
              <View style={{ marginTop: 10 }}>
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    ...
                    >
                      {moment(offer?.date).add(0, "days").calendar()}
                    </Text>
                  </View>
                  <View style={{ flexDirection: "row" }}>
                    <View style={{ flex: 1 }}>
        ...
        <>
          {offer?.response ? (
            ...
            >
              <Text
                onPress={() =>
                  navigation.push("AcceptResponse", { ID: offer?.id })
                }
                style={{
                  fontSize: 16,
              ...
              <Text
                onPress={() =>
                  navigation.push("SeekerNegotiate", { ID: offer?.id })
                }
                style={{
                  fontSize: 16,
                  fontFamily: "poppins_semibold",
