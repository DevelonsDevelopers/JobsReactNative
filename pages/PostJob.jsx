        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: '#F1F1F1', marginBottom: -75 }}>
                ...
                {isPaid ?
                            ...
                            <View style={{ paddingHorizontal: 60 }}>
                                <Ripple rippleColor="blue" rippleOpacity={0.1} rippleDuration={400} rippleSize={300}
                                    ...
                                    style={{
                                        ...
                                        style={{ textAlign: 'center', color: '#0038FF', }}>https://www.example.com </Text></Ripple>
                            </View>
                            <Text style={{
                                textAlign: 'center',
                                color: '#4E4E4E',
                    ...
                    <View>
                        <View>
                            <Image source={require('../assets/steps.png')} style={{ marginLeft: 'auto', marginRight: 'auto' }} />
                            <Text style={{ textAlign: 'center', fontSize: 16, fontFamily: 'poppins_semibold' }}> Few steps more to post your first job  </Text>
                        </View>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        ...
                                        <SafeAreaView style={{ flex: 1 }}>
                                            <FlatList scrollEnabled={false} nestedScrollEnabled={true}
                                                ...
                                                renderItem={({ item }) => (
                                                    <Ripple rippleColor="gray" rippleOpacity={0.2} rippleDuration={800}
                                                        rippleSize={400}
