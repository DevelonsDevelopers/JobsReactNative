                ...
                {(onScrollEndDrag) => (
                    <ScrollView onScrollEndDrag={onScrollEndDrag}>
                        ...
                        <View style={{ padding: 15, alignItems: 'center' }}>
                            ...
                            <View style={{ width: '100%', flexDirection: 'column', marginTop: 10 }}>
                                <Text numberOfLines={1} style={{fontFamily: 'poppins_semibold', marginTop: 7, fontSize: 14}}>Salary Range</Text>
                               ...
                               <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:45}}>
                                   ...
                                   <Text style={{borderWidth:0.1,paddingHorizontal:30,fontSize:14,fontFamily:'poppins_medium',paddingVertical:5 }}>$6490</Text>
                                <Text>-</Text>
                                   <Text>$6490</Text>
                               </View>
                            </View>
