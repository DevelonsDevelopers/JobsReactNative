            ...
            <TouchableWithoutFeedback onPress={toggleVisibility}>
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 12, fontFamily: 'poppins_medium', color: 'gray', marginTop: 10, marginBottom: 20, textAlign: 'center' }}>Do you really want to delete these records? This process cannot be undone.</Text>
                        <View style={{ flexDirection: 'row', gap: 20 }}>
                            <Text onPress={() => toggleVisibility()} style={{ backgroundColor: '#F5F5F7', color: 'gray', fontFamily: 'poppins_medium', fontSize: 17, borderRadius: 10, paddingHorizontal: 40, marginTop: 'auto', marginBottom: 'auto', paddingTop: 7, paddingBottom: 7 }}>Cancel</Text>
                            <Text onPress={() => DeleteData()} style={{ backgroundColor: '#F53E57', color: 'white', fontFamily: 'poppins_medium', fontSize: 17, borderRadius: 10, paddingHorizontal: 40, marginTop: 'auto', marginBottom: 'auto', paddingTop: 7, paddingBottom: 7 }}>Delete</Text>
