        ...
        <Modal visible={visible} animationType={"fade"} transparent={true}  >
            <GestureHandlerRootView style={{
                ...
                <View style={{
                    ...
                    <Text style={{ fontSize: 16, fontFamily: 'poppins_bold', }}>Proposal</Text>
                    <View style={{
                        width: '100%',
                        fontSize: 13,
                        ...
                        <TextInput style={{ width: '100%', borderColor: '#adadad', borderRadius: 20, borderWidth: 0.5, textAlign: 'center', fontSize: 13, fontFamily: 'poppins_medium', padding: 20, marginBottom: 'auto' }}
                            onChangeText={text => setProposal(text)} multiline numberOfLines={5} placeholder={'Introduce Yourself'} ></TextInput>
                    </View>
                    <View style={{
                        width: '100%',
                        fontSize: 13,
